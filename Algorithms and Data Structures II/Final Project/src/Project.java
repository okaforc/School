            ...
            try {
                switch (Integer.parseInt(s)) {
                    ...
                    case 3 -> {
                        ...
                        // check to see if the query returns 0 results, 1 result, or multiple results
                        for (String ignored : FileHandler.search_time(FileHandler.getTimesTST(), time)) {
                            iterated = true;
                            if (count > 1) {
                                hasMultiple = true;
                            }
