...
#define PanSource	"C:\\Users\\user\\Desktop\\Code\\C\\CS_OS\\practical_3\\writer-and-readers.pml"
...
#define _nstates1	56	/* consumer */
#define minseq1	55
#define maxseq1	109
#define _endstate1	55

#define _nstates0	56	/* producer */
#define minseq0	0
#define maxseq0	54
#define _endstate0	55
...
#define Air1	(sizeof(P1) - Offsetof(P1, cno) - 1*sizeof(uchar))
