...
class Collinear {
	 ...
	 *
	 *         Explanation: Two linear for loops looping over N, with binarySearch
	 *         (in log N) being implemented every pass.
	 *
	 *
	 */
	static int countCollinearFast(int[] a1, int[] a2, int[] a3) {
		...
		/**
		 * if binarySearch can find a suitable third element in the third array given a
		 * manipulated formula: x3 = -(x1(y2-y3) + x2(y3-y1))/ y1-y2, then the total
		 * number of valid lines can be increased
		 */
	 ...
	 *
	 *         Explanation: Array is halved a certain number of times, and so scales
